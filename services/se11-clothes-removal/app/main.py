...
app = create_service_app(
    ...
    description=(
        ...
        "## Routes\n"
        "| Route | Description |\n|-------|-------------|\n"
        "| `POST /jobs` | Clothes/person removal (general use) |\n"
        "| `POST /jobs/nsfw` | Production NSFW (fixed quality standards) |\n"
        "| `POST /jobs/nsfw-test` | Experimental NSFW (full parameter control) |\n\n"
        "## Modes\n"
        "| Mode | Description |\n|------|-------------|\n"
        ...
        "| `nsfw_test` | Experimental — use `POST /jobs/nsfw-test` |\n\n"
        "## Upstream Services\n"
