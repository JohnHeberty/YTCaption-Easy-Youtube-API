...
def task_failure_handler(sender: Any = None, task_id: str | None = None, exception: Any = None, args: Any = None, kwargs: Any = None, traceback: Any = None, einfo: Any = None, **kw: Any) -> None:
    """
...
def task_revoked_handler(sender: Any = None, request: Any = None, terminated: Any = None, signum: Any = None, expired: Any = None, **kw: Any) -> None:
    """
...
class CallbackTask(Task):
    ...
    def __init__(self) -> None:
        ...
        self._job_store: RedisJobStore | None = None
...
def normalize_audio_task(self: CallbackTask, job_dict: dict[str, Any]) -> dict[str, Any]:
    """
    ...
    Args:
        job_dict: AudioNormJob serializado como dicionário.
    Returns:
        AudioNormJob atualizado como dicionário com status success/failure.
    """
    ...
    try:
        ...
        try:
            ...
            async def process_with_timeout_and_heartbeat() -> Any:
...
def cleanup_expired_jobs_task() -> dict[str, Any]:
    ...
    Returns:
        Status e quantidade de jobs expirados.
    """
