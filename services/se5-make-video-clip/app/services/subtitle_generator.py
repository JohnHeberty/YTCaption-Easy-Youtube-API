...
class SubtitleGenerator:
    ...
    def segments_to_srt(self, segments: list[dict[str, Any]], output_path: str) -> str:
        """Converte segmentos de transcrição para formato SRT
    ...
    def optimize_segments(self, segments: list[dict[str, Any]],
    ...
    def generate_word_by_word_srt(self, segments: list[dict[str, Any]], output_path: str,
...
def segments_to_weighted_word_cues(segments: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """
