...
def get_path_output() -> str:
    ...
    """
    global config_dict
    path_output = get_dir_or_set_default('path_outputs', '../data/outputs/', make_directory=True)
...
paths_checkpoints = get_dir_or_set_default('path_checkpoints', ['../data/models/checkpoints/'], True)
paths_loras = get_dir_or_set_default('path_loras', ['../data/models/loras/'], True)
...
path_vae = get_dir_or_set_default('path_vae', '../data/models/vae/')
...
path_wildcards = get_dir_or_set_default('path_wildcards', '../data/wildcards/')
path_safety_checker = get_dir_or_set_default('path_safety_checker', '../data/models/safety_checker/')
path_sam = get_dir_or_set_default('path_sam', '../data/models/sam/')
...
def downloading_controlnet_openpose():
    load_file_from_url(
        ...
        model_dir=path_controlnet,
        file_name='controlnet-openpose-sdxl.safetensors'
    )
    return os.path.join(path_controlnet, 'controlnet-openpose-sdxl.safetensors')
