...
# Registry and detectors extracted to task_type_registry.py
_task_type_registry = create_default_registry()
...
# _load_faceid_adapter and _apply_ip_adapter extracted to ip_adapter_worker.py
