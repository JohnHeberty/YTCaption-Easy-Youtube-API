...
class DownloadError(PipelineStageError):
    ...
    def __init__(self, message: str, original: Optional[Exception] = None):
        super().__init__("download", message, original, "se2-video-downloader")
...
class NormalizationError(PipelineStageError):
    ...
    def __init__(self, message: str, original: Optional[Exception] = None):
        super().__init__("normalization", message, original, "se3-audio-normalization")
...
class TranscriptionError(PipelineStageError):
    ...
    def __init__(self, message: str, original: Optional[Exception] = None):
        super().__init__("transcription", message, original, "se4-audio-transcriber")
