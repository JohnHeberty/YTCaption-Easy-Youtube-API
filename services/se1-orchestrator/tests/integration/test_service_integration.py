...
class TestLiveServices:
    ...
    async def test_health_endpoints(self):
        ...
        settings = get_settings()
        services = [
            ("se2-video-downloader", settings.video_downloader_url),
            ("se3-audio-normalization", settings.audio_normalization_url),
            ("se4-audio-transcriber", settings.audio_transcriber_url),
        ]
