...
class OrchestratorSettings(BaseSettings):
    ...
    video_downloader_url: Optional[str] = Field(
        default=None,
        description="URL do serviço se2-video-downloader (http://host:port)"
    )
    audio_normalization_url: Optional[str] = Field(
        default=None,
        description="URL do serviço se3-audio-normalization (http://host:port)"
    )
    audio_transcriber_url: Optional[str] = Field(
        default=None,
        description="URL do serviço se4-audio-transcriber (http://host:port)"
    )
